...
(define (default-cycle-descriptors)
  ...
  (define p1e3-specs
    (list (build-path root "docs/specification/macro.md")
          (build-path root "docs/specification/core-calculus.md")))
  (define p1e3-tests
  ...
  (define p2e1-specs
    (list (build-path root "docs/specification/proof-value.md")
          (build-path root "docs/specification/structural-row.md")
          (build-path root "docs/specification/policy-narrative.md")))
  (define p2e1-tests
    (list (build-path root "model/redex/tests/owned-narrowing-test.rkt")
  ...
  (define p2h3a-tests
    (list (build-path root "model/redex/tests/lexer-test.rkt")
          (build-path root "model/redex/tests/parser-test.rkt")
          (build-path root "model/redex/tests/surface-type-op-test.rkt")))
  (define p2h3b-specs
    (list (build-path root "docs/specification/surface.md")))
  (define p2h3b-tests
