...
(check-equal? (core-free-vars '(BorrowAt 0 y)) (set 'y))
(check-equal? (core-free-vars '(BorrowMutAt 0 y)) (set 'y))
(check-equal? (core-free-vars '(Borrow (#:var y (#:span src 1 2)))) (set 'y))
(check-equal? (core-free-vars '(BorrowMutAt 0 (#:var y (#:span src 1 2))))
              (set 'y))
(check-equal? (core-free-vars '(Let (y let Int) 1 (Borrow y))) (set))
(check-equal? (core-free-vars '(Lam () c0 (y) (BorrowMut y))) (set))
(check-equal? (core-free-vars '(Let (y let Int) 1 (BorrowAt 0 y))) (set))
