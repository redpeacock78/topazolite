...
(test-case
 ...
 ;; 足し忘れや二重登録が通ってしまう。
 (check-equal? (length diagnostic-registry) 180)
...
;; test 12
(test-case
 "schema version は 4、registry version は 15 である"
 (check-equal? diagnostic-schema-version 4)
 (check-equal? diagnostic-registry-version 15))

(test-case
 "typing の registry version 15 と入口 key"
 (check-equal? diagnostic-registry-version 15)
 (check-equal? (diagnostic-code-of 'typing 'ill-typed) "E-TYP-001")
