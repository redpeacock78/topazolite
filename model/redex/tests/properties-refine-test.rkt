...
;; ---------------------------------------------------------------------------
;; proof-value.md §7 決定的回帰: δ ステップの Preservation
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; proof-value.md §7 決定的回帰: 初期 artifact 検証の層
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; proof-value.md §7 決定的回帰: 到達状態検証の層
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; proof-value.md §7 決定的回帰: 発行者対応と出現許可の分離（局所検査との対）
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; bounded counterexample search。seed は bounds に従い、各性質に vacuity
