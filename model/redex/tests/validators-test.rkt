...
(check-false (owned-free? '(NFn (Int) (Owned Res) () () () User)))
(check-false (owned-free? '(NFn ((Owned Res)) Int () () () User)))
(check-false (owned-free? '(NFn () Unit () ((Yield (Owned Res))) () User)))
(check-true (owned-free? '(NFn () Unit () (Suspend) () User)))
